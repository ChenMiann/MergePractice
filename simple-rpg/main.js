let mapArray, ctxm, currentImgMainX, currentImgMainY;
let imgMountain, mgMain, imgEnemy;
$(document).ready(function(){
    ...
    ctx.drawImage(imgMain,0,0,80,130,currentImgMainX,currentImgMainX,200,200);
    };
